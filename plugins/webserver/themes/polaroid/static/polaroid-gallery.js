var polaroidGallery = (function () {
    ...
    function setGallery(arr) {
        ...
        for (i = 0; i < arr.length; i++) {
            out += '<div class="photo" id="' + i + '"><div class="side side-front"><figure>' +
                ...
                '</figure></div><div class="side side-back"><div><p></p></div></div></div>';
        }
    ...
    function shuffle(data) {
        ...
        var y = Math.floor((window.innerHeight - data.item.offsetHeight - navbarHeight-200) * randomY)+100;
