...
class Plugin:
    ...
    def start_config(self,frame,plug):
        ...
        Label(frame,text=_('Caption')).grid(row=3,column=0,padx=5,pady=5,sticky=W)
        ...
        self.capt.grid(row=3,column=1,padx=5,pady=5,sticky=E)	

        self.asdoc_var=BooleanVar()
        self.asdoc_var.set(plug.settings.get('asdoc',0))		
        Checkbutton(frame, text=_("Send as document"),variable=self.asdoc_var,onvalue=1,offvalue=0).grid(row=4,column=0,columnspan=2,padx=5,pady=5,sticky=W)	
